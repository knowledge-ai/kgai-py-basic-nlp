...
run-app: ## runs the dockerized app
	docker run knowledgeai/kgai-py-basic-nlp:$(shell cat "./version.md")

run-app-interactive: ## runs the dockerized app interactive mode
	docker run -it knowledgeai/kgai-py-basic-nlp:$(shell cat "./version.md")

push-image: ## pushes the image to the docker repo
	docker push knowledgeai/kgai-py-basic-nlp:$(shell cat "./version.md")
